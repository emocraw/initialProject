...
async function search() {
    ...
    const url = '../../model/PackDPL/getnotAssigned.php';
...
$('#btnSubmit').on('click', async function () {
    ...
    try {
        const url = '../../model/PackDPL/assignJobtoEmp.php';
        const headers = new Headers();
        headers.append('Content-Type', 'application/json');
        const requestData = {
            checkedIds, jobId
...
async function cancelAssign(cardcode, th_name, checkin, jobassign) {
    cancelObj = {
        cardcode, th_name, checkin, jobassign
    }
...
async function getJobType() {
    const url = '../../model/PackDPL/getJobsByGroup.php';
    const headers = new Headers();
