...
<body>
                ...
                <table class="table border border-2">
                    <thead>
                        <tr class="text-center">
                            ...
                            <th scope="col" style="white-space: nowrap;">เลือกไปแล้ว</th>
                            <th scope="col" style="white-space: nowrap;">เริ่ม</th>
                            <th scope="col" style="white-space: nowrap;">ถึง</th>
                            <th scope="col" style="white-space: nowrap;">บริษัท</th>
        ...
        <div class="row mt-3 px-2 py-2">
            <div style="overflow-x: auto; max-height: 400px;">
                <table class="table border border-2">
                    <thead>
                        <tr class="text-center">
                            <th scope="col" style="white-space: nowrap;">เลขบัตร</th>
    ...
    <script src="../controller/workerManagement.js"></script>
