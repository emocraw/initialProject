...
<body>
    ...
    <div class="container require_approve">
        <div class="row mt-3">
            <div class="col-12">
                <h4 class="text-center text-primary" for="">รับพนักงานเข้าแผนก</h4>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-6">
        ...
        <div id="table_special" class="row mt-3 px-2 py-2">
            <label class="text-danger" for="">ระบบจะทำการยอมรับอัตโนมัติภายใน 3 วัน</label>
            <div>จำนวนคน: <span id="rowCount">0</span></div>
            <div style="overflow-x: auto; max-height: 400px;">
                <table class="table border border-2">
                    <thead>
    ...
    <script src="../controller/receiveEmpSpecial.js?v=1.0"></script>
    <script src="../controller/publicV2.js"></script>
</body>
